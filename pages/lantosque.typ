...
#show: sidebar-site.with(current: "Lantosque")
#set text(lang: "fr")

= Lantosque

#figure(caption: [Blason de la commune], fit-image("/assets/lantosque/blason.svg", width: 15%))
...
La Constitution du 22 frimaire an VIII (13 décembre 1799) modifie ce fonctionnement : les présidents des municipalités cantonales ne sont plus élus, mais nommés par le préfet.

Peu après, la loi du 28 pluviôse an VIII (17 février 1800) abroge le système des municipalités cantonales. Elle introduit à la place des maires et des conseillers, qui remplacent les agents municipaux.
...
== Lantosque sous la Troisième République (1871-1939)
...
#figure(caption: [Le Chalet Fleuri], fit-image("/assets/lantosque/Le chalet Fleuri.webp", width: 50%))
